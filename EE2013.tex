...
\setcounter{LeftFlipBookFrame}{1}
...
\fancyfoot[LE]{
	...
	\begin{picture}
		(18,0)
		\put(0,0){\includegraphics[height=8mm]{pac-a-\theLeftFlipBookFrame}}
	\end{picture}
	%
...
\fancyfoot[RO]{
	...
	\begin{picture}
		(18,0)
		\put(0,0){\includegraphics[height=8mm]{pac-b-\theRightFlipBookFrame}}
	\end{picture}
	%
