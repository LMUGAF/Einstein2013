...
\documentclass[twoside,a5paper,draft,9pt]{scrartcl}
% This needs to come before hyperref to avoid errors
\usepackage{fancyhdr} % adjust header and footer content
\usepackage{iftex}
\ifPDFTeX
