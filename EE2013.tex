...
%%color-definintions
\definecolor{einstein-red}{HTML}{800000}
...
\NewDocumentCommand{\urlItem}{mo}{%
	...
	\begin{adjustbox}{valign=t}%
		\begin{pspicture}(0.54in,0.54in)%
			\psbarcode{http://opha.se/w/\theCode}{width=0.54 height=0.54 parse}{qrcode}%
		\end{pspicture}%
	\end{adjustbox}%
	\vspace{\urlListSpace}%
	&%
	{[}\theLinkCnt{]} \textbf{\theTitle} \newline \url{\theUrl} \newline \url{opha.se/w/\theCode}%
