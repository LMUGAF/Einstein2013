...
\NewDocumentCommand{\httpItem}{omg}{%
	\ifnum\theLinkCnt>1%
		\\[2mm]%
	\fi%
	%
	\IfNoValueTF{#1}%
	{{[}\theLinkCnt{]} & \url{\http #2}}%
	{{[}\theLinkCnt{]} & \textbf{#1} \newline \url{\http #2}}%
	%
	\IfNoValueTF{#3}%
	{}%
	{\urlLabel{#3}{\theLinkCnt}}%
	\setcounter{LinkCnt}{\theLinkCnt+1}%
}



% \newcommand{\httpItem}[2][x]{%
% 	\item asd #2%[asd #2] {[}\theLinkCnt{]} \url{\http #2}%
% 	\setcounter{LinkCnt}{\theLinkCnt+1}%
% }
\newcommand{\httpsItem}[1]{\httpItem{#1}}
