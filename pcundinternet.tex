...
\paragraph{Vorlesungsverzeichnis (Lehre Studium Forschung - LSF)}\hfill\\
\begin{itemize}
...
\paragraph{Für alle Studierenden der LMU}
\begin{itemize}
	\item <vorname.nachname>@campus.lmu.de (bzw. was ihr angegeben habt)
	\item Webmail unter: 
		\begin{urlList}
			\httpsItem{mailbox.portal.uni-muenchen.de}
		\end{urlList}
	      Zum Weiterleiten einfach links unten auf Weiterleitung klicken und eine andere Email-Adresse angeben.
\end{itemize}
...
\begin{itemize}
	...
	\item Beantragung der Kennung während der O-Phase, in den ersten zwei Wochen des Semesters oder zu den Sprechstunden der RBG (Mo--Fr, 13--17 Uhr) jeweils in der Oettingenstr. 67, in LU113.
	\item Webmail unter
		\begin{urlList} 	
			\httpItem{www.webmail.ifi.lmu.de}
                \end{urlList}
	\item Infos unter
		\begin{urlList}
			\httpItem{www.rz.ifi.lmu.de/Dienste/Mailsystem.html}
		\end{urlList}
\end{itemize}
...
\begin{itemize}
	...
	\item Webmail unter 
		\begin{urlList}
			\httpItem{webmail.physik.uni-muenchen.de}
		\end{urlList}
	\item Infos unter 
		\begin{urlList}
			\httpItem{www.it.physik.uni-muenchen.de/dienste/kommunikation/e-mail}
		\end{urlList}
        \item Passwort wie bei 
		\begin{urlList}
			\httpItem{www.campus.lmu.de}.
		\end{urlList}
\end{itemize}
...
Wir empfehlen dir, das WLAN mit dem Namen (SSID) \emph{eduroam}, auf deinen Geräten einzurichten. Mit diesem einmal eingerichteten Eduroam kannst du weltweit an vielen Universitäten und Forschungsinstituten automatisch das dortige WLAN nutzen. Unter \begin{urlList}
	\httpItem{www.lrz.de/services/netz/mobil/eduroam}
...
\begin{urlList}
	\httpItem{tools.rz.ifi.lmu.de/cipconf/index.rb?op=msdnaa}
	\httpsItem{msdnaa.physik.uni-muenchen.de/}
\end{urlList}
...
\begin{urlList}
	\httpItem{www.ub.uni-muenchen.de/elektronische-medien/hilfe-anleitungen/easyproxy/}
\end{urlList}
