...
in den ersten drei Monate nach Studienbeginn von der
...
Bei einer privaten Krankenversicherung gibt es die Möglichkeit, bis zum 25.
...
sollte sich dem Solidarprinzip hier nicht im Vorfeld entziehen. Dies ist
...
Höhe bekommst du mit dem BAföG-Rechner \ref{rechner}. Bei einem \enquote{Nein} im Rechner kann es trotzdem sein, dass du BAföG
...
\begin{urlList}
	\urlItem{http://www.lmu.de/deutschlandstipendium}[dstip]
	\urlItem{http://www.lmu.de/studium/studienfinanzierung/stift}
	\urlItem{http://www.mystipendium.de/}[mystip]
\end{urlList}
