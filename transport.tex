...
an Ampeln. Wer das ignoriert, ist schnell mal 100~€ los und sammelt
...
Falls du dein Fahrrad einmal nicht mehr brauchst, zum Beispiel weil du in eine andere Stadt ziehst, dann
lass es bitte nicht einfach vor der Uni stehen. Wenn du nicht weißt, was du damit machen sollst, kannst
du den Hausmeistern Bescheid geben, damit sie es entsorgen.
...
findest du auf der Karte am Ende dieses Heftes.
...
Studenten. Beim Zahlen deines Studienbeitrages ist dir sicherlich
aufgefallen, dass du einen Solidarbeitrag in Höhe von 61,00~€ leisten musst.
...
%- die anderen Hochschulen in München haben teilweise andere Laufzeiten für ihre Semester.
...
Matrikelnummer zur Eingabe bereit), erhältst du zwei Belege: das Ticket
...
Umständen auch der vom MVV angebotene \emph{Ausbildungstarif II}
...
MVG-Kundencenter am Hauptbahnhof, Ostbahnhof oder in der \mbox{Poccistraße}~1--3 (alle
...
\section{Auto}
Du kommst im Allgemeinen mit dem Auto nicht schneller durch die Stadt, als mit dem ÖPNV oder dem Fahrrad. Spätestens bei der Parkplatzsuche vor der Uni wirst du merken, dass es bessere Möglichkeiten gibt, in die Uni zu kommen.
